...
urlpatterns = [
    ...
    path('author/posts/views/', freeridersocial.Posts.visible_post.as_view(), name='get_post_for_user_view'),
    path('posts/views/', freeridersocial.Posts.public_post.as_view(), name='public_posts_view'),
    path('author/myPosts/views/', freeridersocial.Posts.my_post.as_view(), name='my_post_view'),
    path('author/posts/', freeridersocial.views.get_visible_post_render, name='get_post_for_user'),
    path('posts/', freeridersocial.views.get_posts_render, name='public_posts'),
    path('author/myPosts/', freeridersocial.views.get_my_posts_render, name='my_posts'),
    ...
    path('posts/<uuid:post_id>/comments/view/', freeridersocial.Comments.get_comments.as_view(), name='comments_view'),
    path('posts/<uuid:post_id>/comments/', freeridersocial.views.comments_render, name='comments'),
]
